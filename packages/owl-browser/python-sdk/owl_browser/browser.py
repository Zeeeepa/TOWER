...
class Browser:
    ...
    def new_page(
        ...
        context_id = self._core.create_context(options)
    ...
    def add_license(
        ...
        Args:
            ...
            license_content: Base64-encoded license content (alternative to path)
        ...
        Example:
            ...
            # From base64 content
            browser.add_license(license_content="base64encodedcontent...")
            ```
        """
        params = {}
        if license_path:
            params["license_path"] = license_path
        if license_content:
            params["license_content"] = license_content
        self._core.send_command("addLicense", params)
