...
if TYPE_CHECKING:
    from web2api.builder.analyzer.page_analyzer import (
        PageAnalysisResult,
        InteractiveElement,
        ComponentInfo,
    )
    from web2api.builder.analyzer.element_classifier import (
        ClassificationResult,
        ElementPurpose,
    )
    from web2api.builder.crawler.state_manager import StateGraph, StateTransition
