...
if TYPE_CHECKING:
    from web2api.builder.analyzer.page_analyzer import PageAnalysisResult
    from web2api.builder.analyzer.element_classifier import ClassificationResult, UserJourney
    from web2api.builder.discovery.flow_detector import UserFlow
    from web2api.builder.discovery.form_analyzer import FormAnalysis
    from web2api.builder.discovery.api_detector import APIDetectionResult
